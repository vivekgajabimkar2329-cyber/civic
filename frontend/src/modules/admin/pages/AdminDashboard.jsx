...
import { initialComplaints, weeklyChartData, categoryData } from '../../common/data/mockData';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col">
          <div className="p-6 border-b border-gray-100 flex items-center justify-between">
            ...
            <button onClick={() => navigate('/admin/complaints')} className="text-indigo-600 text-sm font-medium hover:text-indigo-700 transition-colors">
              View All
            </button>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex flex-col">
          ...
          <div className="flex flex-col gap-3">
            <button onClick={() => navigate('/report')} className="w-full flex items-center gap-3 bg-indigo-500 hover:bg-indigo-600 text-white p-4 rounded-xl transition-colors shadow-sm shadow-indigo-200">
              <Plus size={20} />
